...
import Background from "../../assets/backgroundQuemSomos.png";
...
<p>Nosso compromisso é conectar boas causas a quem deseja fazer a diferença, criando pontes entre empresas, voluntários e projetos sociais que realmente transformam vidas.
        </p>
        </div>
    </section>
  );
